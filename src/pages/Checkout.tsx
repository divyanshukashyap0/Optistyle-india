        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <p className="text-slate-500 mb-6">
                    ...
                    Your order <span className="font-mono font-bold text-slate-900">#{orderId}</span> has been placed and your order details have been emailed.<br/>
                    If you do not see the email, check your Spam/Promotions folder and mark it as &quot;Not spam&quot; to keep future updates in your inbox.
                </p>
