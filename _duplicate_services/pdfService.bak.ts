...
const finishPDF = (doc: any, pageWidth: number, pageHeight: number, certId: string, startY: number) => {
    // --- DISCLAIMER ---
    const disclaimerText1 = "AI-assisted vision screening result only. Not a medical prescription.";
    const disclaimerText2 = "Consult a certified eye care professional before purchasing lenses.";
